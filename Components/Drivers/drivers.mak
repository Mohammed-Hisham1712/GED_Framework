...
ifdef CONFIG_ATMODEM_USE
DRIVERS_SRCDIRS += $(COMPONENT_PATH)/Modem
DRIVERS_INCDIRS += $(COMPONENT_PATH)/Modem

DRIVERS_DEFINES += CONFIG_ATMODEM_DEFAULT_TSK_STACK_SIZE=$(CONFIG_ATMODEM_DEFAULT_TSK_STACK_SIZE)
DRIVERS_DEFINES += CONFIG_ATMODEM_DEFAULT_TSK_PRIORITY=$(CONFIG_ATMODEM_DEFAULT_TSK_PRIORITY)

endif #CONFIG_ATMODEM_USE