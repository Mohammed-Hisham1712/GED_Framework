...
PLATFORM_EXTRA_SRCDIRS := $(PATH_ROOT)/Components/Utils
PLATFORM_EXTRA_SRCDIRS += $(PATH_MCU)

PLATFORM_EXTRA_INCDIRS := $(PATH_ROOT)/Components/Utils
PLATFORM_EXTRA_INCDIRS += $(PATH_ROOT)/Components/Utils/Bit_Wise

PLATFORM_SRCDIRS := $(HAL_SRCDIRS) $(DRIVERS_SRCDIRS) $(RTOS_SRCDIRS) $(PLATFORM_EXTRA_SRCDIRS)
PLATFORM_INCDIRS := $(HAL_INCDIRS) $(DRIVERS_INCDIRS) $(RTOS_INCDIRS) $(PLATFORM_EXTRA_INCDIRS)
PLATFORM_EXCLUDES :=
PLATFORM_DEFINES :=
